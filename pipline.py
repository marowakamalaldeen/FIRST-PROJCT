...
✅ Sort 31,553 points into regions based on Cerebra ID ✅ Compute RMS per time activation for each region ✅ Visualize each region's RMS separately and plot them
"""
